...
import { User, MenuItem, Table, InventoryItem, Booking, Order, WalletTransaction, Notification, Review, RestaurantSetting } from "./models";
...
const seedDatabase = async () => {
    try {
        ...
        await RestaurantSetting.destroy({ where: {} });
