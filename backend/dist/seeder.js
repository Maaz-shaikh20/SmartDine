...
const seedDatabase = async () => {
    try {
        ...
        await models_1.Booking.destroy({ where: {} });
        await models_1.Order.destroy({ where: {} });
        await models_1.WalletTransaction.destroy({ where: {} });
        await models_1.Notification.destroy({ where: {} });
        await models_1.Review.destroy({ where: {} });
        await models_1.RestaurantSetting.destroy({ where: {} });
        // Clear parent tables
        await models_1.Table.destroy({ where: {} });
        await models_1.InventoryItem.destroy({ where: {} });
        await models_1.MenuItem.destroy({ where: {} });
        ...
        // 2. Create Menu Items
        await models_1.MenuItem.bulkCreate([
            // Chicken Starters
        ...
        // 3. Create Tables
        await models_1.Table.bulkCreate([
        ...
        await models_1.InventoryItem.bulkCreate([
