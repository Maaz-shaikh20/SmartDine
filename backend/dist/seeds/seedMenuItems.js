...
exports.seedMenuItems = void 0;
const MenuItem_1 = __importDefault(require("../models/MenuItem"));
const seedMenuItems = async () => {
    try {
        const count = await MenuItem_1.default.count();
        if (count === 0) {
            console.log("Menu table is empty, seeding default menu items...");
...
exports.seedMenuItems = seedMenuItems;
