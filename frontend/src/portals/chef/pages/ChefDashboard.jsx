...
const ChefDashboard = () => {
  ...
  const statCards = [
    ...
    },
    {
      ...
      icon: <Icons.historyIcon size={24} />,
      accent: "#6366f1",
      bg: "#ede9fe",
    },
  ];
  ...
  const quickLinks = [
    {
      ...
      path: "/chef/orders",
      icon: <Icons.chef size={20} />,
    },
    {
      label: "Order History",
      path: "/chef/history",
      icon: <Icons.historyIcon size={20} />,
    },
    ...
    <div className="chef-page">
      <header className="admin-page-header">
        ...
        <p className="admin-page-subtitle">
          Manage your orders and stay on top of the kitchen workflow.
        </p>
      ...
      <div className="chef-info-strip">
        <span>
          <Icons.clock size={14} className="inline-icon" /> Dashboard refreshes
          every 10 seconds
        </span>
        <span>
          <Icons.utensils size={14} className="inline-icon" /> SmartDine Kitchen
          System
        </span>
        <span>
          <Icons.trendingUp
