...
const AdminLayout = ({ children }) => {
  ...
  const navItems = [
    ...
    {
      path: "/admin/tables-bookings",
      label: "Tables & Bookings",
      icon: <Icons.armchair size={22} />,
      tooltip: "Tables & Bookings",
    },
    {
      path: "/admin/orders",
      label: "Orders",
    ...
    },
    {
      path: "/admin/menu",
      label: "Menu",
      icon: <Icons.utensilsCrossed size={22} />,
      tooltip: "Menu",
    },
    {
      path: "/admin/reviews",
      label: "Reviews",
      icon: <Icons.reviews size={22} />,
      tooltip: "Reviews",
    },
  ];
  ...
  return (
    <div
      className={`admin-dashboard ${sidebarOpen ? "sidebar-open" : "sidebar-closed"}`}
    >
      <aside className="admin-sidebar">
        <div className="sidebar-header">
          ...
          >
            ...
            {sidebarOpen && (
              <span style={{ transition: "opacity 0.3s" }}>SmartDine</span>
            )}
          </h2>
          <Button
            variant="ghost"
