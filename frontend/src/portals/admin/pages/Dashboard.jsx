        ...
        <>
          ...
          >
            <div className="admin-card">
              ...
              >
                <Icons.trendingUp size={20} color="var(--brand-primary)" />{" "}
          ...
          >
            ...
            <div className="admin-card">
              ...
              >
                ...
                >
                  <Icons.calendar size={18} color="var(--brand-primary)" />{" "}
                  RECENT BOOKINGS
                </h3>
                <Button
                  variant="secondary"
              ...
              <div className="chef-items-container">
                {(stats?.recentBookings || []).map((b) => (
                  ...
                  >
                    ...
                    <span
                      className={`status-pill-modern status-modern-${b.status?.toLowerCase()}`}
                    >
                      {b.status}
                    </span>
                  </div>
            ...
            <div className="admin-card">
              ...
              >
                ...
                >
                  <Icons.shoppingBag size={18} color="var(--brand-primary)" />{" "}
                  RECENT ORDERS
                </h3>
                <Button
                  variant="secondary"
                ...
                {(stats?.recentOrders || []).map((o, idx) => (
                  <React.Fragment key={o.id}>
                    ...
                    >
                      ...
                      <span
                        className={`status-pill-modern status-modern-${o.status?.toLowerCase()}`}
