...
const Tables = ({ hideHeader = false }) => {
  ...
  const filteredTables = tables.filter((t) => {
    ...
    const matchesStatus =
      ...
      t.status.toLowerCase() === activeFilters.status.toLowerCase();
    const matchesCapacity =
      !activeFilters.capacityRange ||
      (activeFilters.capacityRange === "small"
        ? t.capacity <= 2
        : activeFilters.capacityRange === "medium"
          ? t.capacity > 2 && t.capacity <= 4
          : t.capacity >= 6);
      ...
      {!hideHeader && (
        <header className="admin-page-header">
          ...
          <p className="admin-page-subtitle">
            Configure your restaurant floor plan and table capacities.
          </p>
