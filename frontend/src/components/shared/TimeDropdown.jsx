...
const TimeDropdown = ({ value, onChange, minTime }) => {
  ...
  return (
    <div
      className="custom-time-dropdown-container"
      ref={containerRef}
    ...
    >
      ...
      {isOpen && (
        <div
          className={`time-popup popup-animation ${openUpward ? "open-upward" : ""}`}
        >
                  ...
                  {filteredSlots.map((time) => {
                    ...
                    return (
                      ...
                      >
                        ...
                        {isRecommended && (
                          <span className="recommended-slot">⭐</span>
                        )}
                        {isFastFilling && (
