...
const EditProfilePage = lazy(
  () => import("./portals/customer/pages/EditProfilePage"),
);
const ChangePasswordPage = lazy(
  () => import("./portals/customer/pages/ChangePasswordPage"),
);
const WalletHistory = lazy(
  () => import("./portals/customer/pages/WalletHistory"),
);
            ...
            <Routes>
              ...
              <Route element={<CustomerLayout />}>
                ...
                <Route path="/customer" element={<CustomerPortal />}>
                  <Route
                    index
                    element={<Navigate to="/customer/myorders" replace />}
                  />
