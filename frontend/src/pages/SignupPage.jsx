...
const SignupPage = () => {
  ...
  const getPasswordStrength = (password) => {
    ...
    if (hasNumber && hasSpecial && hasUpper && password.length >= 8)
  ...
  return (
    <div className="auth-container">
      <div className="auth-card">
        <h1>
          <Icons.utensils size={32} className="logo-icon" /> SmartDine
        </h1>
        ...
        <form onSubmit={handleSubmit} className="auth-form">
              ...
              <div className="password-feedback">
                <div className="strength-indicator">
                  ...
                  >
                    ...
                    {passwordStrength.label === "Strong" && (
                      <Icons.check size={14} className="inline-icon" />
                    )}
                  </span>
                </div>
                <div className="password-requirements">
                  ...
                  {passwordRequirements.map((req, idx) => (
                    <div
                      key={idx}
                      className={`requirement-item ${req.met ? "satisfied" : ""}`}
                    >
                      {req.met ? (
          ...
          <div className="form-group">
            ...
            {formData.confirmPassword && (
              <div
                className={`match-feedback ${passwordsMatch ? "success" : "error"}`}
              >
                {passwordsMatch ? (
                  <>
                    <Icons.check size={14} className="inline-icon" /> Passwords
                    match
                  </>
                ) : (
                  <>
                    <Icons.close size={14} className="inline-icon" /> Passwords
                    do not match
                  </>
                )}
              </div>
