      ...
      <section className="hero">
        <div className="hero-grid-container">
          <div className="hero-text-content">
            ...
            <p>
              Experience the finest culinary culture at Rasoi Ghar. Delicious
              food meets authentic recipes for an unforgettable meal.
            </p>
      ...
      <section className="menu-section" id="featured-menu">
        <div className="section-header">
          ...
          <p className="menu-subtitle">
            Taste the most loved dishes from our kitchen
          </p>
        </div>
      ...
      <section className="book-table-section">
        <div className="book-table-grid">
          ...
          <div className="book-table-content">
            ...
            <p>
              Skip the wait and secure your spot for a delightful dining
              experience. Perfect for family gatherings, dates, or celebrating
              special moments.
            </p>
      ...
      <section className="showcase">
        <div className="showcase-content">
          <div className="showcase-text">
            ...
            <p>
              Enjoy a comfortable and elegant restaurant environment where
              delicious food meets great hospitality.
            </p>
